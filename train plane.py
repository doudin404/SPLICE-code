...
if __name__ == '__main__':
    ...
    # 数据模块
    files = 'data/02691156_airplane'  # 替换为实际路径
    dm = VoxelRayDataModule(root_dir=files, batch_size=10, num_workers=5,data_name="dae_net")
    # 定义模型
    model = SPLICE_Module.load_from_checkpoint("checkpoints_splice/last-v9.ckpt",lr=1e-3)
    ...
    last_ckpt = "checkpoints_splice/last-v12.ckpt"
    if last_ckpt:
