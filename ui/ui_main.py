...
def main():
    args = sys.argv
    select = 0
    opt = (options.Options(device=torch.device('cuda:0'), tag='chairs_sym_hard', model_name="occ_gmm"),
           options.Options(device=torch.device('cuda:0'), tag='airplanes_sym_hard', model_name="occ_gmm"),
           options.Options(device=torch.device('cuda:0'), tag='guitars_tb', model_name="occ_gmm"),
           options.Options(device=torch.device('cuda:0'), tag='coseg_vases', model_name="occ_gmm"))[select].load()
