...
class GaussianData:
    ...
    @eigen.setter
    def eigen(self, new_eigen: np.ndarray):
    ...
    def __init__(self, gaussian):
        self.recover_data = [item.copy() if type(item) is np.ndarray else item for item in gaussian]
