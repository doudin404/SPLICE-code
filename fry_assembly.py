...
def main(cfg: DictConfig = None):
    ...
    # 创建模型
    ae = model.noodles.NoodlesModel.load_from_checkpoint("checkpoints/正式3,无kl.ckpt",**cfg.train,map_location=lambda storage, loc: storage.cuda(1)).to("cuda:1")
    ae.eval()
    # ae = None
    ...
    Fry = model.fried_noodles.FryModel.load_from_checkpoint("checkpoints/fry/求别搞我.ckpt",ae=ae,gf=gf,**cfg.fry).to("cuda:1")
    Fry.eval()
