...
def gm_log_likelihood_loss(
    gms: Union[Tuple[Tensor, ...], List[Tensor]],
    x: Tensor,
    get_supports: bool = False,
    mask: Optional[Tensor] = None,
    reduction: str = "mean",
) -> Union[Tensor, Tuple[Tensor, Union[Tuple[Tensor, ...], List[Tensor]]]]:
...
def split_mesh_by_gmm(
    mesh: Tuple[Tensor, Optional[Tensor]],
    gmm: Union[Tuple[Tensor, ...], List[Tensor]],
