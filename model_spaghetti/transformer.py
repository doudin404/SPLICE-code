...
class MultiHeadAttention(nn.Module):
    ...
    def forward_interpolation(self, queries: torch.Tensor, keys: torch.Tensor, values: torch.Tensor, alpha: torch.Tensor, mask: Optional[torch.Tensor] = None) -> Union[Tuple[Optional[torch.Tensor], ...], List[Optional[torch.Tensor]]]:
    ...
    def forward(self, x, y: Optional[torch.Tensor] = None, mask: Optional[torch.Tensor] = None, alpha: Optional[torch.Tensor] = None):
...
class TransformerLayer(nn.Module):
    ...
    def forward_with_attention(self, x, y: Optional[torch.Tensor] = None, mask: Optional[torch.Tensor] = None, alpha: Optional[torch.Tensor] = None):
